...
public class LoginRequest implements com.atwebpages.musictrack.request.Request {
	...
	public Response send() throws ClientProtocolException, IOException {
		String response = Request.Post(Endpoints.LOGIN.getURL())
				                 .bodyString(account.getAsJSON(), ContentType.APPLICATION_JSON)
				                 .execute().returnContent().asString();
		return new Response(response, Endpoints.LOGIN);
	}
